...
namespace SqlReflectTest.DataMappers
{
    public class ProductDataMapper : AbstractDataMapper
    {
        ...
        public ProductDataMapper(string connStr, bool withCache) : base(connStr, withCache)
        {
            categories = new CategoryDataMapper(connStr, withCache);
            suppliers = new SupplierDataMapper(connStr, withCache);
        }
