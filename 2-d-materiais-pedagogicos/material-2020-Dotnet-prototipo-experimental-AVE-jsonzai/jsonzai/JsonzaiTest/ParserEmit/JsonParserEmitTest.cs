...
namespace Jsonzai.Test.ParserEmit {
    ...
    [TestClass]
    public class JsonParserEmitTest {
        
        [TestMethod]
        public void TestIntArray() {
            string src = "[1, 2, 3]";
            int[] arr = JsonParserEmit.Parse<int[]>(src);
        ...
        public void TestSiblings() {
            ...
            Person p = JsonParserEmit.Parse<Person>(src);
        ...
        public void TestParsingPersonArray() {
            ...
            Person [] ps = JsonParserEmit.Parse<Person[]>(src);
        ...
        public void TestParsingClassroom() {
            ...
            Classroom cl = JsonParserEmit.Parse<Classroom>(src);
        ...
        public void TestParsingSerializedClassroom() {
            ...
            Classroom cl2 = JsonParserEmit.Parse<Classroom>(src);
        ...
        public void TestParsingSerializedAccount() {
            ...
            Account acc2 = JsonParserEmit.Parse<Account>(src);
        ...
        public void TestParsingSerializedRgbColor() {
            ...
            RgbColor color2 = JsonParserEmit.Parse<RgbColor>(src);
        ...
        public void TestParsingWorkUsingJsonConvertAttribute() {
            ...
            Work work = JsonParserEmit.Parse<Work>(src);
        ...
        public void TestParsingGitHubProfileUsingJsonConvertAttribute()
        {
            ...
            GitHubProfile profile = JsonParserEmit.Parse<GitHubProfile>(src);
        ...
        public void TestParsingSerializedGitHubProfileUsingJsonConvertAttribute() {
            ...
            GitHubProfile profile2 = JsonParserEmit.Parse<GitHubProfile>(src);
